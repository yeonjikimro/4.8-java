...
public class Operator_01 {
	...
	public static void main(String[] args) {
		 ...
		 * 명령문의 시작은 keyword, 와 변수만 올 수 있다.
		 * keyword로 시작하는 명령문은 어떤 기능을 수행하는 경우
		 ...
		 * 3. intNum1 에 저장된 값을 읽어서 intNum2 에 저장한다.
		 */
		...
		// 대입연산식을 따로 떼어서 바라보자
		// 1. intNum2 + 10 을 연산하고
		// 2. 결과를 intNum1에 대입(저장한다.
		// 3. intNum1 에 저장된 값을 console 에 출력하고
		// 4. intNum1 의 값을 그대로 유지한다.
