...
public class Var_01 {
	...
	public static void main(String[] args) {
		...
		// 선언된 정수형 변수 num3, 4에 정수 40, 100을 대입/할당/저장하기
		num3 = 40;
		num4 = 100;
		/*
		 ...
		 * 변수 명명 규칙과 패턴
		 * 1. 첫 글자는 무조건 소문자(규칙)
		 * 2. 이후에는 대소문, 숫자, _를 조합할 수 있다.(규칙)
		 * (패턴)
		 * 3. 두 개 이상의 단어를 조합하여 만드는 것이 좋다.
		 * 4. 두 개 이상의 단어를 조합할 때 두 번째 단어부터 대문자
		 * 		=> camel case
		 * 5. 두 개 이상의 단어를 조합할 때 첫 번째 단어는
